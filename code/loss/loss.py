...
"""
29-Okt-21
https://github.com/PeterouZh/Omni-GAN-PyTorch/blob/3d29f5a33a6d018344f23c7d9a787a98735f1e16/exp/omni_loss/omni_loss.py
"""
import os
import torch
import torch.nn.functional as F
...
class OmniLoss(object):
  ...
  def __call__(self, pred, positive=None, negative=None, default_label=0, margin=None, gamma=None):
    pred = pred.type(torch.int64)
    positive = positive.type(torch.int64)
