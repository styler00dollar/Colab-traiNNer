"""
BasicSR/codes/models/modules/LPIPS/dist_model.py (6-Dez-20)
https://github.com/victorca25/BasicSR/blob/master/codes/models/modules/LPIPS/dist_model.py
"""
