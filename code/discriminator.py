def CreateDiscriminator(cfg):
    ...
    # NFNet
        ...
        import timm
        netD = timm.create_model(cfg['network_D']['timm_model'], 
        ...
        netD = UNetDiscriminator(num_in_ch=cfg['network_D']['num_in_ch'], 
        ...
        netD = UNetDiscriminatorSN(num_in_ch=cfg['network_D']['num_in_ch'], 
            num_feat=cfg['network_D']['num_feat'], 
            skip_connection=cfg['network_D']['skip_connection'])
