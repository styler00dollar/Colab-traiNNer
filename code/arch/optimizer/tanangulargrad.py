"""
tanangulargrad.py (25-06-21)
https://github.com/mhaut/AngularGrad/blob/947417d42f591eeecabe6dbeb524a4d220252bd4/myoptims/tanangulargrad.py
"""
    ...
    def step(self, closure=None):
        ...
        for group in self.param_groups:
            for p in group["params"]:
                ...
                exp_avg, exp_avg_sq, previous_grad, min, diff, final_tan_theta = (
                    state["exp_avg"],
                    state["exp_avg_sq"],
                    state["previous_grad"],
                    state["min"],
                    state["diff"],
                    state["final_tan_theta"],
                )
                ...
                angular_coeff = (
                    torch.tanh(abs(final_tan_theta)) * 0.5 + 0.5
