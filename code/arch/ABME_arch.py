...
def conv_a(in_planes, out_planes, kernel_size=3, stride=1, padding=1, dilation=1, activation=True):
    if activation:
...
class ABMRNet(nn.Module):
    ...
    def __init__(self, md=2):
        ...
        self.conv1_Res = conv_a(16, 16, kernel_size = 3, stride=1, padding=1 ,activation=False)
        """
