...
class InpaintGenerator(nn.Module):
    def __init__(self, residual_blocks=8):
        ...
        self.kpn_model = KPN(color=True, burst_length=1, blind_est=True, kernel_size=[5], sep_conv=False,
                 channel_att=False, spatial_att=False, upMode='bilinear', core_bias=False, filter_type='64')
...
class MISF(nn.Module):
    def __init__(self, residual_blocks=8, use_spectral_norm=True):
        ...
        self.EdgeGenerator = EdgeGenerator(residual_blocks=residual_blocks, use_spectral_norm=use_spectral_norm)
