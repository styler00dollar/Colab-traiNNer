# https://github.com/Zdafeng/SwinFIR/blob/main/swinfir/archs/swinfir_arch.py
# https://github.com/Zdafeng/SwinFIR/blob/main/swinfir/archs/swinfir_utils.py
...
class WindowAttention(nn.Module):
    ...
    def __init__(
        ...
        # print("qk_scale: ", qk_scale, head_dim)
...
class SwinFIR(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.conv_first = nn.Conv2d(4, embed_dim, 3, 1, 1)
        ...
        if self.upsampler == "pixelshuffle":
            ...
            self.conv_last = nn.Conv2d(num_feat, 4, 3, 1, 1)
