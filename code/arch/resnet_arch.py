...
resnet34_config = ResNetConfig(
    block=BasicBlock, n_blocks=[3, 4, 6, 3], channels=[64, 128, 256, 512]
)
...
resnet101_config = ResNetConfig(
    block=Bottleneck, n_blocks=[3, 4, 23, 3], channels=[64, 128, 256, 512]
)

resnet152_config = ResNetConfig(
    block=Bottleneck, n_blocks=[3, 8, 36, 3], channels=[64, 128, 256, 512]
)
...
def resnet50(num_classes, pretrain=True):
    ...
    if pretrain == True:
        ...
        print("Loaded resnet50 pretrain.")
...
def resnet101(num_classes, pretrain=True):
    ...
    if pretrain == True:
        ...
        pretrained_model.fc = fc
        model.load_state_dict(pretrained_model.state_dict())
        print("Loaded resnet101 pretrain.")
...
def resnet152(num_classes, pretrain=True):
    ...
    if pretrain == True:
        ...
        pretrained_model.fc = fc
        model.load_state_dict(pretrained_model.state_dict())
        print("Loaded resnet152 pretrain.")
