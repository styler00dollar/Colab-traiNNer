...
class BasicLayer(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 ...
                 use_checkpoint=False, use_deformable_block=False, sequential_self_attention=False):
        ...
        self.blocks = nn.ModuleList([
            Block(in_channels=dim,
                  ...
                  dropout_path=drop_path[i] if isinstance(drop_path, list) else drop_path,
                  sequential_self_attention=sequential_self_attention)
...
class RSTB(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size,
                 ...
                 use_deformable_block=False, sequential_self_attention=False):
