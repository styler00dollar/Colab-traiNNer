...
class FlowUpsamplerNet(nn.Module):
    ...
    def arch_FlowStep(self, H, K, LU_decomposed, W, actnorm_scale, affineInCh, flow_coupling, flow_permutation,
                      hidden_channels, normOpt, n_conditinal_channels=None):
    ...
    def arch_additionalFlowAffine(self, H, LU_decomposed, W, actnorm_scale, hidden_channels):
        ...
        if 'additionalFlowNoAffine' in cfg['network_G']['flow']:
            ...
            n_additionalFlowNoAffine = int(cfg['network_G']['flow']['additionalFlowNoAffine'])
