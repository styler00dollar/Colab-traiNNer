"""
20-Mai-2020
https://github.com/victorca25/BasicSR/blob/14aced7d1049a283761c145f3cf300a94c6ac4b9/codes/models/modules/architectures/glow/thops.py
"""
import torch
...
def cat_feature(tensor_a, tensor_b):
    return torch.cat((tensor_a.cuda(), tensor_b.cuda()), dim=1)
