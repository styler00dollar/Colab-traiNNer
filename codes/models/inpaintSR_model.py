...
class inpaintSRModel(BaseModel):
    def __init__(self, opt):
        super(inpaintSRModel, self).__init__(opt)
    ...
    def feed_data(self, data, need_HR=True):
        ...
        #self.lr_gray = data['img_LR_gray'].to(self.device)
        self.lr_edges = data['img_LR_canny'].to(self.device)
    ...
    def test(self):
        ...
        with torch.no_grad():
            if self.is_train:
                ...
                self.fake_H = self.netG(self.var_L, self.lr_edges, isTest=True)
