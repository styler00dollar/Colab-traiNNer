"""
basicblock.py (19-12-20)
https://github.com/cszn/KAIR/blob/master/models/basicblock.py

network_usrnet.py (19-12-20)
https://github.com/cszn/KAIR/blob/master/models/network_usrnet.py
"""
...
class USRNet(nn.Module):
    ...
    def forward(self, x, k, sf, sigma):
        '''
        x (input image): tensor, NxCxWxH
        k (kernel): tensor, Nx(1,3)xwxh
        sf (splitting factor): integer, 1
        sigma (noise level): tensor, Nx1x1x1
        '''
